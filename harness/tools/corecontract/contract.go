...
var gateStepRules = []stepRule{
	{"contract", "G-CONTRACT", "go-test", []string{"go", "-C", "harness", "test", "-json",
	...
	{"harness-build", "G-UNIT", "command",
		[]string{"go", "-C", "harness", "build", "./cmd/..."}},
	{"harness-unit", "G-UNIT", "go-test", []string{"go", "-C", "harness", "test", "-json",
		"./cmd/...", "./internal/...", "./tools/...", "./test/contracts", "-count=1"}},
	{"harness-race", "G-UNIT", "go-test",
		[]string{"go", "-C", "harness", "test", "-json", "-race",
			"./cmd/...", "./internal/...", "./tools/...", "./test/contracts", "-count=1"}},
	{"fuzz-model", "G-UNIT", "go-fuzz", []string{"go", "-C", "harness", "test", "-json",
		"./internal/model", "-run", "^$", "-fuzz",
		"^FuzzParseSignedPublication$", "-fuzztime=100x"}},
	{"fuzz-peer", "G-UNIT", "go-fuzz", []string{"go", "-C", "harness", "test", "-json",
		"./internal/peer", "-run", "^$", "-fuzz",
		"^FuzzReadChannelFrame$", "-fuzztime=100x"}},
	{"fuzz-artifact", "G-UNIT", "go-fuzz",
		[]string{"go", "-C", "harness", "test", "-json",
			"./internal/artifact", "-run", "^$", "-fuzz",
			"^FuzzParseManifest$", "-fuzztime=100x"}},
	{"process", "G-PROCESS", "go-test", []string{"go", "-C", "harness", "test", "-json",
