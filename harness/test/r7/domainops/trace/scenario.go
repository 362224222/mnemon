...
var scenarioFiles = []string{
	"test/r7/domainops/Dockerfile",
	"test/r7/domainops/run_live.sh",
	"testdata/r7/domain-ops/README.md",
	"testdata/r7/domain-ops/cmd/domain-load/main.go",
	"testdata/r7/domain-ops/cmd/domain-world/main.go",
	"testdata/r7/domain-ops/cmd/domainctl/main.go",
	"testdata/r7/domain-ops/cmd/domainctl/main_test.go",
	"testdata/r7/domain-ops/compose.yaml",
	"testdata/r7/domain-ops/domains/data/AGENTS.md",
	"testdata/r7/domain-ops/domains/edge/AGENTS.md",
	"testdata/r7/domain-ops/domains/lead/AGENTS.md",
	"testdata/r7/domain-ops/domains/payment/AGENTS.md",
	"testdata/r7/domain-ops/domains/platform/AGENTS.md",
	"testdata/r7/domain-ops/mission.md",
	"testdata/r7/domain-ops/nodes.txt",
	"testdata/r7/domain-ops/world/callback.go",
...
func rejectUnboundScenarioFixtures(root string) error {
	const fixturePrefix = "testdata/r7/domain-ops/"
