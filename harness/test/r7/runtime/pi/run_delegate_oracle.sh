...
current_extension="$harness_root/internal/attach/assets/pi/mnemond-current.ts"
...
mkdir -p "$scratch/bin"
install -m 0755 "$runtime_dir/current-rpc-harness.sh" "$scratch/bin/mnemon-harness"
