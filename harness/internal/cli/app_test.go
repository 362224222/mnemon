...
func (client *fakeAgencyClient) Current(_ context.Context, _ attachment,
	...
	return []byte(`{"schema":"mnemon.agent.view","version":5,"view":"view:test","outstanding":{"open_total":0,"related_total":0,"related_projected":0,"truncated":false},"allowed_intents":[]}`), nil
}
...
func TestHookAttachKeepsCurrentThatOwnsAHandling(t *testing.T) {
	fixture := newAppFixture(t)
	fixture.client.currentView = []byte(`{"schema":"mnemon.agent.view","version":5,` +
