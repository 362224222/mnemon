...
type ChannelReplayProbeRequest = node.ChannelReplayProbeRequest
...
type ChannelPublicationRefView = node.ChannelPublicationRefView
type ChannelEventKeyView = node.ChannelEventKeyView
type ChannelPublicationView = node.ChannelPublicationView
...
type ChannelMutationCounts = node.ChannelMutationCounts
type ChannelForensicCounts = node.ChannelForensicCounts
type ChannelAbandonResponse = node.ChannelAbandonResponse
type ChannelReplayProbeResponse = node.ChannelReplayProbeResponse
