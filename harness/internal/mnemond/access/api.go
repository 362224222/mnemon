...
// It grows by phase: Ingest (P0), PullPresentationView (P2). The access layer owns this port; the runtime
...
type ServerAPI interface {
	...
	PullPresentationView(principal contract.ActorID, sub contract.Subscription) (view.View, error)
}
