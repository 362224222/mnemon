...
// generic. The load-bearing invariant: the core — contract, channel, kernel, store, eventview,
...
// mnemon a protocol; everything specific (capabilities, hosts, demos) is an
