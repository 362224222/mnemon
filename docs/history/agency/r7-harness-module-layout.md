...
Status: **RETIRED / HISTORICAL**. C0 through C6 were completed before the
Harness module was promoted into the root product module. This document records
the former Harness structure and the cut order that reached it; it owns no
current behavior or package boundary.

On any conflict, [`docs/mnemond/core-contract.md`](../../mnemond/core-contract.md)
wins. Nothing here adds,
